defmodule Protohackers.PricesServerTest do
  ...
  test "handles clients separately" do
    {:ok, socket1} = :gen_tcp.connect(~c"localhost", 5005, mode: :binary, active: false)
    {:ok, socket2} = :gen_tcp.connect(~c"localhost", 5005, mode: :binary, active: false)
